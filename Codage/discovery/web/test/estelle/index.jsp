...
<div class="container">
  ...
  <button id="add" onClick="add()" type="button" class="btn btn-primary active">Ajouter une actualité</button>
  <button id="mod" onClick="" type="button" class="btn btn-primary disabled">Modifier l'actualité</button>
